...
echo -e "\033[92m"      
echo "  ____  ____     _     ____  ____    _     ____  _____  "
echo " / ___||  _ \   / \   / ___||  _ \  / \   / ___|| ____| "
echo "| |  _ | |_) | / _ \  \___ \| |_) |/ _ \ | |    | |___   "
echo "| |_| ||  _ < / ___ \  ___) | | _// ___ \| |___ | |___  "
echo " \____||_| \_/_/   \_\|____/|_|  /_|   |_\_____||_____| "
echo                          
echo -e "\033[39m"
...
congrats(){
    ...
    if [[ "$status" = "200" ]]; then
        ...
        echo ==========================
        echo -e "\033[39m"
        echo "If there are no errors, graspace should be up and running!"
    else    
        echo -e "\033[93m"
        ...
        echo ==========================
        echo -e "\033[39m"
        echo "Check if GraSpace is running, maybe we tried to reach it too soon."
    fi
