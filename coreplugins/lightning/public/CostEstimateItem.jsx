    ...
    componentDidUpdate(prevProps) {
        if (
            ...
            if (this.props.taskInfo.selectedNode.key !== "auto") {
                $.get(`/plugins/lightning/is_lightning_node?id=${this.props.taskInfo.selectedNode.key}`).done(json => {
        ...
        if (this.state.show) {
            if (
                prevProps.taskInfo.resizeMode !== this.props.taskInfo.resizeMode ||
...
// Estimate the credits
    estimateCredits = () => {
        ...
        const getEstimate = () => {
            ...
            if (taskInfo.resizeMode === ResizeModes.YES || taskInfo.resizeMode === ResizeModes.YESINBROWSER) {
